...
Source0  : https://files.pythonhosted.org/packages/9e/af/56efe21c53ac81ac87e000b15e60b3d8104224b4313b6eacac3597bd183d/setproctitle-1.3.6.tar.gz
...
%prep
%setup -q -n setproctitle-1.3.6
cd %{_builddir}/setproctitle-1.3.6
pushd ..
cp -a setproctitle-1.3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746027656
