...
Source0  : https://files.pythonhosted.org/packages/c4/4d/6a840c8d2baa07b57329490e7094f90aac177a1d5226bc919046f1106860/setproctitle-1.3.5.tar.gz
...
%prep
%setup -q -n setproctitle-1.3.5
cd %{_builddir}/setproctitle-1.3.5
pushd ..
cp -a setproctitle-1.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740410863
